...
function ContainerDonut(props) {
    ...
    return (
      <div className="donut">
        <div className="donut-btn">
       <button className="donut-btn_left" onClick={() => {
             
               props.setCurrentStep(2)
        }}><i class="fas fa-arrow-alt-circle-left"></i></button>
        <button className="donut-btn_right" onClick={() => {props.setCurrentStep(3)}}><i class="fas fa-arrow-alt-circle-right"></i></button>
        </div>
        <Palette state={state}/>
        <Canvas>
          <Stars />
